...
**总纪律：以代码为准。发现"文档说了、代码没有"→ 记入 `docs/issues/`（现有 0001-0012；0001-0006/0008/0009/0011/0012 已解决；**0010 已处置 2026-08-27**——deployment.md §9 客户端指引落地；**0007 处置中 2026-08-27**——game_time 尾追加移植，见 issue 文末）；格式见下。**
...
> **当前未决**：（无）——ISSUE-0010 已处置（2026-08-27，deployment.md §9 指引 + 记档）；ISSUE-0007 game_time 移植处置中（2026-08-27），见各 issue 文末记录。
