...
**总纪律：以代码为准。发现"文档说了、代码没有"→ 记入 `docs/issues/`（现有 0001-0012，0001-0006/0008/0009/0011/0012 已解决，0007/0010 待解决，格式见下）。**
...
> **当前未决**：ISSUE-0007（game_time 钩子——断线恢复缺"玩家进度"维度，移植形态见该 issue，低危预留）、ISSUE-0010（CreateRoom 非幂等——响应丢失重试得 RoomIdOccupied + 孤儿房风险，协议级限制，低危）。
